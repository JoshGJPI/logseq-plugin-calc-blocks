...
export const createUnitClass = /* #__PURE__ */ factory(name, dependencies, ({
  ...
  const UNIT_SYSTEMS = {
    si: {
      ...
      UNIFORM_LOAD: { unit: UNITS.plf, prefix: PREFIXES.SHORT[''] },
      MOMENT: { unit: UNITS.lbft, prefix: PREFIXES.SHORT[''] },
